...
function Update () {
    ...
    // remove if you don't want mouse to control camera
...
//remove if you dont' want mouse to countrol camera */
	}
    ...
    if (Input.GetKey(KeyCode.Delete)){ //If player wants to move on X and Z axis only
